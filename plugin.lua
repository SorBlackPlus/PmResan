function run(msg)
	...
	about_key = {{{text = "وبسایت تیم پرایم" , url = "http://LovelyCreation.blogfa.ir"}},{{text = "کانال تیم پرایم" , url = "https://telegram.me/PrimeTeam"}},{{text = "پیام رسان سازنده" , url = "https://telegram.me/PmSorBlackBot"}},{{text = "سربلک" , url = "https://telegram.me/SorBlack"}}}
	start_txt = "سلام دوست عزيز\n\n`از طریق این ربات حتی اگر ریپورت باشی هم میتونی با من چت کنی. این ربات قابلیت های دیگه ای هم داره که از کیبرد زیر میتونی بهشون دست پیدا کنی. اگر از این ربات پیشرفته ی پیام رسان نیاز داری، روی کلید زیر کلیک کن. این ربات رایگان نیست و توسط تیم قدرتمند پرایم طراحی و ساخته شده.`"
	start_key = {{{text="ساخت ربات پیام رسان",url="https://telegram.me/PmSorBlackBot"}}}
	...
	elseif msg.text:find("/spam") and msg.chat.id == admingp then
		...
		if target then
			...
			elseif #target == 2 then
				send_msg(admingp, "`شخص مورد نظر در حال اسپم خوردن است`\n_Your target_ *Spamming*", true)
				for i=1,tonumber(target[2]) do
					send_msg(tonumber(target[1]), "PrimeTeam\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nPrimeTeam")
				end
				return send_msg(admingp, "`اسپم به اتمام رسید`\n_Spamming_ *Stoped*", true)
			else
				send_msg(admingp, "`شخص مورد نظر در حال اسپم خوردن است`\n_Your target_ *Spamming*", true)
...
function inline(msg)
	...
	tabless = '[{"text":"اکانت اصلی من","url":"https://telegram.me/SorBlack'..sudo_user..'"}],[{"text":"کانال شخصی من","url":"https://telegram.me/PrimeTeam'..sudo_ch..'"}],[{"text":"کانال سازنده","url":"https://telegram.me/PrimeTeam"},{"text":"سازنده ربات","url":"https://telegram.me/SorBlack"}]'
